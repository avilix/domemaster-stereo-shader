...
//Name: domemaster-stereo-rig.ma
//Last modified: Sat, Jul 28, 2012 10:55:52 AM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 239 179 239 ;
	setAttr ".r" -type "double3" -27.905266384380916 44.999999999999986 -4.0481852097554499e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 382.46960663561231;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "robLookupCamera";
	setAttr ".t" -type "double3" 239 179 239 ;
	setAttr ".r" -type "double3" -27.905266384380916 44.999999999999986 -4.0481852097554499e-14 ;
createNode camera -n "robLookupCameraShape" -p "robLookupCamera";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 382.46960663561231;
...
createNode rob_lookup_background -n "rob_lookup_background1";
createNode mib_texture_filter_lookup -n "mib_texture_filter_lookup1";
...
createNode mib_texture_vector -n "mib_texture_vector1";
	setAttr ".S01" 4;
createNode mib_texture_remap -n "mib_texture_remap1";
createNode domeAFL_FOV_Stereo -n "domeAFL_FOV_Stereo1";
	setAttr ".cam" 1;
createNode mib_texture_filter_lookup -n "mib_texture_filter_lookup2";
...
createNode mib_texture_remap -n "mib_texture_remap2";
createNode mib_texture_vector -n "mib_texture_vector2";
	setAttr ".S01" 4;
createNode domeAFL_FOV_Stereo -n "domeAFL_FOV_Stereo2";
	setAttr ".cam" 2;
createNode polyCube -n "polyCube1";
	...
	setAttr ".d" 300;
	setAttr ".cuv" 4;
createNode lambert -n "checkerLambert";
createNode shadingEngine -n "lambert2SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
createNode file -n "file1";
	setAttr ".ftn" -type "string" "/Users/dsi/Documents/maya/projects/Domemaster3D-Stereo-Rig//sourceimages/luminance-cube-texture.png";
...
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-defaultImage \"\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"single\\\" -ps 1 100 100 $gMainPane;\"\n\t\t\t\t-removeAllPanels\n\t\t\t\t-ap true\n\t\t\t\t\t(localizedPanelLabel(\"Render View\")) \n\t\t\t\t\t\"scriptedPanel\"\n\t\t\t\t\t\"$panelName = `scriptedPanel -unParent  -type \\\"renderWindowPanel\\\" -l (localizedPanelLabel(\\\"Render View\\\")) -mbv $menusOkayInPanels `\"\n\t\t\t\t\t\"scriptedPanel -edit -l (localizedPanelLabel(\\\"Render View\\\")) -mbv $menusOkayInPanels  $panelName\"\n\t\t\t\t$configName;\n\n            setNamedPanelLayout (localizedPanelLabel(\"Current Layout\"));\n        }\n\n        panelHistory -e -clear mainPanelHistory;\n        setFocus `paneLayout -q -p1 $gMainPane`;\n        sceneUIReplacement -deleteRemaining;\n        sceneUIReplacement -clear;\n\t}\n\n\ngrid -spacing 20 -size 100 -divisions 2 -displayAxes yes -displayGridLines yes -displayDivisionLines yes -displayPerspectiveLabels no -displayOrthographicLabels no -displayAxesBold yes -perspectiveLabelPosition axis -orthographicLabelPosition edge;\n"
...
connectAttr "rob_lookup_background1.msg" "robLookupCameraShape.mils";
...
connectAttr "domeAFL_FOV_Stereo1.msg" "stereoCameraLeftShape.mils";
...
connectAttr "domeAFL_FOV_Stereo2.msg" "stereoCameraRightShape.mils";
...
connectAttr "mib_texture_filter_lookup1.S08R" "rob_lookup_background1.S04";
connectAttr "mentalrayTexture1.msg" "mib_texture_filter_lookup1.s00";
connectAttr "mib_texture_remap1.S12" "mib_texture_filter_lookup1.S01";
connectAttr "mib_texture_vector1.S04" "mib_texture_remap1.S00";
connectAttr "mib_texture_filter_lookup1.S08R" "domeAFL_FOV_Stereo1.S08";
connectAttr "mib_texture_filter_lookup2.S08R" "domeAFL_FOV_Stereo1.S09";
connectAttr "mentalrayTexture2.msg" "mib_texture_filter_lookup2.s00";
connectAttr "mib_texture_remap2.S12" "mib_texture_filter_lookup2.S01";
connectAttr "mib_texture_vector2.S04" "mib_texture_remap2.S00";
connectAttr "mib_texture_filter_lookup1.S08R" "domeAFL_FOV_Stereo2.S08";
connectAttr "mib_texture_filter_lookup2.S08R" "domeAFL_FOV_Stereo2.S09";
connectAttr "file1.oc" "checkerLambert.c";
connectAttr "checkerLambert.oc" "lambert2SG.ss";
connectAttr "pCubeShape1.iog" "lambert2SG.dsm" -na;
connectAttr "lambert2SG.msg" "materialInfo1.sg";
connectAttr "checkerLambert.msg" "materialInfo1.m";
...
connectAttr "checkerLambert.msg" ":defaultShaderList1.s" -na;
connectAttr "mib_texture_filter_lookup1.msg" ":defaultTextureList1.tx" -na;
connectAttr "mentalrayTexture1.msg" ":defaultTextureList1.tx" -na;
connectAttr "mib_texture_vector1.msg" ":defaultTextureList1.tx" -na;
connectAttr "mib_texture_remap1.msg" ":defaultTextureList1.tx" -na;
connectAttr "mib_texture_filter_lookup2.msg" ":defaultTextureList1.tx" -na;
connectAttr "mentalrayTexture2.msg" ":defaultTextureList1.tx" -na;
connectAttr "mib_texture_remap2.msg" ":defaultTextureList1.tx" -na;
connectAttr "mib_texture_vector2.msg" ":defaultTextureList1.tx" -na;
connectAttr "file1.msg" ":defaultTextureList1.tx" -na;
connectAttr "pointLightShape1.ltd" ":lightList1.l" -na;
connectAttr "rob_lookup_background1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "domeAFL_FOV_Stereo1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "domeAFL_FOV_Stereo2.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "place2dTexture1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "pointLight1.iog" ":defaultLightSet.dsm" -na;
// End of domemaster-stereo-rig.ma
